document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleArduinoData(data) {
        ...
        document.getElementById('arduinoData').innerText = data;
    ...
    const port = new SerialPort('COM3', { baudRate: 9600 }); //remember to replace COM3 with arduino's port
    ...
    setTimeout(() => {
        ...
        document.getElementById('arduinoData').innerText = data;
        document.getElementById('arduinoData').style.display = 'block';
    }, 3000);
}
);
